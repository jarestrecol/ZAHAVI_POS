...
| MIGRACION | Claude / Codex | F3-3/4/5/8 hechas (0018–0023); sigue F3-11 | db/migraciones/0014_operacion.sql, db/migraciones/0015…0023_*.sql, db/local/pruebas-{operacion,api}.sql, entregas/CONTRATO-RPC.md, scripts/probar-sql.mjs, scripts/verificar-sql.mjs, scripts/{generar,test}-casos-costeo.mjs, db/pruebas/casos-costeo.json |
...
- Sigue: F3-11 (RLS por rol y sede). Espera: revisión de 0015–0022 (Codex); Codex conecta el cliente (F3-6/F3-7).
